"""
TEST 3d: Volatility-Filtered with 20% Edge Requirement
...
EDGE_REQUIREMENT = 20.0  # 5% additional edge requirement

client = FMPClient()

print("="*80)
print("TEST 3d: VOLATILITY-FILTERED WITH 5% EDGE REQUIREMENT")
print("="*80)
...
summary.to_csv('../data/test3d_edge_filter_20pct_results.csv', index=False)
print(f"\nResults saved to: ../data/test3d_edge_filter_20pct_results.csv")
...
plt.tight_layout()
plt.savefig('../plots/test3d_edge_filter_20pct_portfolio.png', dpi=300, bbox_inches='tight')
print(f"Plot saved to: ../plots/test3d_edge_filter_20pct_portfolio.png")
